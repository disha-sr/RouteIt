...
public class DatabaseHelper3 extends SQLiteOpenHelper {
    ...
    public static final String FIELD_GEOM = "geom";
    ...
    public Cursor getAllLocations(){
        return mDB.query(DATABASE_TABLE, new String[] { FIELD_ROW_ID,  FIELD_LAT , FIELD_LNG, FIELD_GEOM } , null, null, null, null, null);
    }
    @Override
